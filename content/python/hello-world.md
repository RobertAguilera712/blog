...
programa es solucionar un problema, para eso tiene que recibir datos de
...
La función `:::python input` recibe como parámetro el texto con el que pediremos al
usuario que ingrese algún dato, en este caso el nombre. Como resultado nos da lo
...
En este post aprendiste a imprimir texto en pantalla, usando la función `:::python print`
y a recibir datos del usuario, usando la función `:::python input`. En el siguiente tutorial veremos cómo trabajar con números y realizar operaciones básicas en Python.
